...
import { getAuth, GoogleAuthProvider, signInWithPopup } from "./firebase/firebase-config.js";
import { app } from './firebase/firebase-config.js'; // Ajuste o caminho conforme necessário
